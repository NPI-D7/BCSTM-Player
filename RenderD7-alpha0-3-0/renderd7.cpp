...
bool RenderD7::DrawImageFromFile(RenderD7::Image *img, float x, float y, float scaleX, float scaleY)
{
	return C2D_DrawImageAt(img->img, x, y, 0.5f, nullptr, scaleX, scaleY);
}