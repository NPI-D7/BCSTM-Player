...
namespace D7 {
    class BCSTM {
        ...
        inline unsigned int GetLoopStart() {
            return this->loop_start;
        }
        inline unsigned int GetLoopEnd() {
            return this->loop_end;
        }
        inline unsigned int GetChannelCount() {
            return this->channel_count;
        }
        inline unsigned int GetTotal() {
            return this->num_blocks;
        }
        inline unsigned int GetCurrent() {
        ...
        std::vector<unsigned char, RD7::LinearAllocator<unsigned char>> buffer_data[2][buffer_count];
    };
}